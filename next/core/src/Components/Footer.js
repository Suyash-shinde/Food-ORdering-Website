...
const Footer = () => {
  return (
    ...
    <div className="w64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
        <Image src="/Logo.png" width={120} height={120}/>
        <span className="ml-3 text-xl">Digital Food Ordering System</span>
      </a>
      <p className="mt-2 text-sm text-gray-500">A onestop junction for all of your cravings!!!</p>
    </div>
    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 hover:text-gray-800">FirstLink</a>
          </li>
          <li>
  ...
  <div className="bg-gray-100">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-500 text-sm text-center sm:text-left">© 2023 DFOS —
