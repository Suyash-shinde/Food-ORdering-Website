...
<Navbar />
      <div className='flex'>
        <div className='text-8xl grow h-screen/2 pt-36 bg-gradient-to-t align-middle from-red-300 to-pink-400 text-red-50'>
      ...
      <div className='bg-rose-100'>
        ...
        <div className="flex flex-nowrap px-6 overflow-x-auto">
          <div className="flex flex-auto flex-col p-4 shadow-xl mx-6 shrink-0 rounded-xl bg-white">
            <Image src="/tomato.jpeg" width={200} height={100} className='rounded-xl' />
            <div className="mt-4">
              <h3 className="text-gray-500 text-xs title-font mb-1">CATEGORY</h3>
              <h2 className="text-gray-900 title-font text-lg font-medium">The soup</h2>
          ...
          <div className="flex flex-auto flex-col p-4 shadow-xl mx-6 shrink-0 rounded-xl bg-white">
            ...
            <div className="mt-4">
              <h3 className="text-gray-500 text-xs title-font mb-1">CATEGORY</h3>
              <h2 className="text-gray-900 title-font text-lg font-medium">Brunch</h2>
              <p className="mt-1">Rs.150.00</p>
            </div>
          </div>
          <div className="flex flex-auto flex-col p-4 shadow-xl mx-6 shrink-0 rounded-xl bg-white">
            ...
            <div className="mt-4">
              <h3 className="text-gray-500 text-xs title-font mb-1">CATEGORY</h3>
              <h2 className="text-gray-900 title-font text-lg font-medium">The tomato soup</h2>
              <p className="mt-1">Rs.150.00</p>
            </div>
          </div>
          <div className="flex flex-auto flex-col p-4 shadow-xl mx-6 shrink-0 rounded-xl bg-white">
            ...
            <div className="mt-4">
              <h3 className="text-gray-500 text-xs title-font mb-1">CATEGORY</h3>
              <h2 className="text-gray-900 title-font text-lg font-medium">Dinner</h2>
              <p className="mt-1">Rs.150.00</p>
            </div>
          </div>
          <div className="flex flex-auto flex-col p-4 shadow-xl mx-6 shrink-0 rounded-xl bg-white">
