...
export default function Page() {
  ...
  return (
    ...
    <div className='flex justify-evenly items-center pt-24'>
      <button  onClick={() => router.push('/menu')}className='m-4 border-none border-2 rounded-md shadow-xl bg-teal-500 text-center text-white p-6 cursor-pointer font-bold font-sans hover:shadow-teal-800/40'><img src='/Customer Icon.jpg' width={150} className='rounded-xl p-1'/><hr />Customer</button>
